...
/**
 * Created by prafulljoshi on 26/08/17.
 */

public class HomePageSliderImageAdapter extends PagerAdapter {

    Context context;

    private int[] sliderImages;

    private Bitmap[] sliderBitmaps;
    ...
    public HomePageSliderImageAdapter(Context context,int[] sliderImages, Bitmap[] sliderBitmaps) {
        this.context = context;
        this.sliderImages = sliderImages;
        this.sliderBitmaps = sliderBitmaps;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        sliderImageView.setImageBitmap(sliderBitmaps[position]);
